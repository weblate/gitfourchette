...
class Ui_WelcomeWidget(object):
    def setupUi(self, WelcomeWidget):
        ...
        self.gridLayout.addWidget(self.newRepoButton, 6, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.cloneRepoButton, 8, 1, 1, 1)
        self.openRepoButton = QPushButton(parent=WelcomeWidget)
        self.openRepoButton.setObjectName("openRepoButton")
        self.gridLayout.addWidget(self.openRepoButton, 7, 1, 1, 1)
        spacerItem5 = QSpacerItem(20, 27, QSizePolicy.Policy.Minimum, QSizePolicy.Policy.Expanding)
        ...
        self.gridLayout.addWidget(self.recentReposButton, 4, 1, 1, 1)
    ...
    def retranslateUi(self, WelcomeWidget):
        ...
        self.recentReposButton.setText(_translate("WelcomeWidget", "Recent repositories"))
