...
class Ui_CloneDialog(object):
    ...
    def retranslateUi(self, CloneDialog):
        ...
        self.recurseSubmodulesCheckBox.setText(_translate("CloneDialog", "Recurse into submodules (if any)"))
        ...
        self.keyFilePicker.setText(_translate("CloneDialog", "Log in with custom &key file"))
        self.statusGroupBox.setTitle(_translate("CloneDialog", "Status"))
